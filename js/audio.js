...
(function(){
  ...
  function radioPanelHTML(){
    ...
    return '<section class="dungeonRadio" aria-label="Dungeon Radio">'+
      ...
      '<div class="radioJoin" style="margin-top:18px;padding-top:16px;border-top:1px solid #555;text-align:center;line-height:1.35">'+
       '<div style="color:#E9BB00;font-weight:900;letter-spacing:.06em;margin-bottom:8px">JOIN DUNGEON RADIO</div>'+
       '<div style="font-weight:800;margin-bottom:7px">Got a rock track you’d like featured on Dungeon Radio?</div>'+
       ...
       '<div style="margin-top:10px"><b>Send us your track: <a href="mailto:info@gunpowderstudios.co.uk">info@gunpowderstudios.co.uk</a></b></div>'+
      '</div>'+
     '</section>';
  }
  ...
  function start(){discoverRadioTracks();installSoundButton();const charSelect=document.getElementById('charSelect');if(charSelect)new MutationObserver(syncToScreen).observe(charSelect,{attributes:true,attributeFilter:['class','style','hidden']});syncToScreen();}
